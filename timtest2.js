...
for(var i=1;i<autourl.length;i++)document.write("<div class='tline'><input type=text class='msinput' name=txt"+i+" size=10 value=测试中……><img src='images/arrow.png' border='0' /><input class='urlinput' type=text name=url"+i+" size=40>&nbsp;<input type='button'  onclick='window.open(this.form.url"+i+".value)' class='buttonopen'></div>")
